...
type
  ...
  public
    ...
    property oznacma: boolean read foznacma write foznacma;
  ...
  public
    ...
    procedure oznacma(acanvas:tcanvas;tvar:ttvar);
    property plist: TList read flist;
    property pocettvarov : integer read pocet write pocet ;
  end;                                                            //aj get tvar bodu function gettvarbodu tpoint: ttvar   //tu pridat pocet tvarov ako property
...
begin
  ...
  begin
    ...
    ATvar.Nakreslit(ACanvas);
     if atvar.oznacma then
       begin
         oznacma(acanvas,atvar);
       end;
...
procedure tzoznamtvarov.oznacma(acanvas:tcanvas;tvar: TTvar);
var
atvar:ttvar;
begin
 with acanvas do
                     ...
                     //ellipse((atvar.Vlavo+atvar.sirka div 2)-10,(atvar.Hore+atvar.vyska div 2)-10,(atvar.Vlavo+atvar.sirka div 2)+10,(atvar.Hore+atvar.vyska div 2)+10);
                     end;
